<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DesvincularProveedor.aspx.cs" Inherits="WebApplication4.WebForm12" %>
...
<body>
    <form class="form-horizontal" runat="server">
        ...
        <div class="container">
            <h1 class="auto-style1">Desvincular Proveedor</h1>
        </div>
        <div class="container">
        ...
        <div class="container">
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input class="form-control" id="disabledInput3" type="text" placeholder="R.U.T Proveedor..." disabled="disabled"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-3 control-label">
                ...
                <div class="col-md-3">
                    <input class="form-control" id="disabledInput4" type="text" placeholder="R.U.T Proveedor..." disabled="disabled"/>
                </div>
            </div>
